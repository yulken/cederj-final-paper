...
uma implementação da interface IGamesRepository, também não há necessidade de
realizar nenhuma alteração no Caso de Uso nem para a realização dos testes e nem
será preciso caso haja a necessidade de trocar o \emph{TypeORM} por algum outro
...
\paragrafo{Com isso, o módulo CreateGameService.spec.ts testa, com
