...
\begin{itemize}[label=\raisebox{0.25ex}{\normalsize$\bullet$}]
    ...
    \item \hspace{0.1cm} \emph{Back-end}: \emph{Node.js} com \emph{Typescript}
    \item \hspace{0.1cm} \emph{Front-end}: \emph{React.js}
    \item \hspace{0.1cm} Banco de dados: \emph{PostgreSQL}
    \vspace{0.6cm}
\end{itemize}
